      ...
      <section className='contact mtop'>
        <div className='container flex'>
          <div className='main-content'>
            ...
            <p>Llena el siguiente formulario de contacto, nos comunicaremos contico muy pronto.</p>
          ...
          <div className='side-content'>
            <h3>Vísitanos</h3>
            <p>Podemos adjuntar una dirección aquí.</p>
            <br />

            <h3>Envíanos un email!</h3>
            <span>info@cosiam.net</span>
            <br />
            <span>+5731000000</span>
            <br />
